...
func NewPostgreSQL() User {
	return &postgresql{}
}

func (p *postgresql) selectUserByID(id int) error {
	return nil
}

func (p *postgresql) selectUserByName(name string) error {
	return nil
}

func (p *postgresql) selectUserByCity(city string) error {
	return nil
}
